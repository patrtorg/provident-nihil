> **MSW 2.0 is finally here! 🎉** Read the [Release notes](https://github.com/patrtorg/provident-nihil/releases/tag/v2.0.0) and please follow the [**Migration guidelines**](https://@patrtorg/provident-nihiljs.io/docs/migrations/1.x-to-2.x) to upgrade. If you're having any questions while upgrading, please reach out in our [Discord server](https://kettanaito.com/discord).
>
...
<p align="center">
  <img src="media/@patrtorg/provident-nihil-logo.svg" width="100" alt="Mock Service Worker logo" />
</p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@patrtorg/provident-nihil" target="_blank"><img src="https://img.shields.io/npm/v/@patrtorg/provident-nihil.svg?style=for-the-badge&label=Latest&color=black" alt="Package version" /></a>
  <a href="https://www.npmjs.com/package/@patrtorg/provident-nihil" target="_blank"><img src="https://img.shields.io/npm/dm/@patrtorg/provident-nihil?style=for-the-badge&color=black" alt="Downloads per month" /></a>
...
- [Documentation](https://@patrtorg/provident-nihiljs.io/docs)
- [**Getting started**](https://@patrtorg/provident-nihiljs.io/docs/getting-started)
- [FAQ](https://@patrtorg/provident-nihiljs.io/docs/faq)

## Examples

- See the list of [**Usage examples**](https://github.com/@patrtorg/provident-nihiljs/examples)

## Browser

- [Learn more about using MSW in a browser](https://@patrtorg/provident-nihiljs.io/docs/integrations/browser)
- [`setupWorker` API](https://@patrtorg/provident-nihiljs.io/docs/api/setup-worker)
...
[![What is Mock Service Worker?](https://raw.githubusercontent.com/@patrtorg/provident-nihiljs/@patrtorg/provident-nihil/main/media/@patrtorg/provident-nihil-video-thumbnail.jpg)](https://youtu.be/HcQCqboatZk)
...
import { http, HttpResponse } from '@patrtorg/provident-nihil'
import { setupWorker } from '@patrtorg/provident-nihil/browser'
...
![Chrome DevTools Network screenshot with the request mocked](https://github.com/patrtorg/provident-nihil/blob/main/media/@patrtorg/provident-nihil-quick-look-network.png?raw=true)
...
- [Learn more about using MSW in Node.js](https://@patrtorg/provident-nihiljs.io/docs/integrations/node)
- [`setupServer` API](https://@patrtorg/provident-nihiljs.io/docs/api/setup-server)

### How does it work?

There's no such thing as Service Workers in Node.js. Instead, MSW implements a [low-level interception algorithm](https://github.com/@patrtorg/provident-nihiljs/interceptors) that can utilize the very same request handlers you have for the browser. This blends the boundary between environments, allowing you to focus on your network behaviors.
...
import { http, HttpResponse } from '@patrtorg/provident-nihil'
import { setupServer } from '@patrtorg/provident-nihil/node'
...
> Don't get overwhelmed! We've prepared a step-by-step [**Getting started**](https://@patrtorg/provident-nihiljs.io/docs/getting-started) tutorial that you can follow to learn how to integrate Mock Service Worker into your project.
...
**You can change that!** Consider [sponsoring the effort](https://github.com/sponsors/@patrtorg/provident-nihiljs) behind one of the most innovative approaches around API mocking. Raise a topic of open source sponsorships with your boss and colleagues. Let's build sustainable open source together!
...
>
> **Learn more on our [GitHub Sponsors profile](https://github.com/sponsors/@patrtorg/provident-nihiljs)**.
...
<table>
  <tr>
    ...
    <td>
      <a href="https://www.chromatic.com/?ref=@patrtorg/provident-nihiljs" target="_blank">
...
<table>
  <tr valign="middle">
    <td width="124">
      <img src="https://raw.githubusercontent.com/@patrtorg/provident-nihiljs/@patrtorg/provident-nihil/main/media/tech-radar.png" width="124" alt="Technology Radar">
    </td>
    <td>
  ...
  <tr>
    <td width="124">
      <img src="https://raw.githubusercontent.com/@patrtorg/provident-nihiljs/@patrtorg/provident-nihil/main/media/os-awards.png" width="124" alt="Open Source Awards 2020">
    </td>
    <td>
